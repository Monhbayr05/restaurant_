...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Ангилал Жагсаалт</h6>
        <div class="float-end">
        ...
        <table id="dataTable" class="table table-striped" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-10">Restaurant name</th>
